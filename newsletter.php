...
<html>
	<head>
		<title>Newsletter - Rush Running Company</title>
		<meta charset="utf-8" />
					...
					<article id="newsletter">
						...
						<section class="wrapper style2">
							<div class="inner">
								...
								<form action="/files/newsletter-mailer.php" method="post" enctype="multipart/form-data">
									 <div>
										...
										<!-- 
										<input type="checkbox" name="form[element2]" value="yes"/>
										<label for="form[element2]">*Subscribe to Newsletter:</label>
										<br /><br />
										-->
										<div class="6u 12u$(small)">
											<input <?php echo check('element2', 'checkbox'); ?> type="checkbox" name="form[element2]" value="yes" id="form[element2]"/>
											<label for="form[element2]">*Subscribe to Newsletter</label>
										</div>
										<div />
										<br />
										...
										<input class="form-input-button" type="submit" name="submitButton" value="Subscribe" />
									</div>
								</form>
								<br />
